...
**Invariant compliance:** All three approaches preserve the seven Core Invariants. The core protocol records decisions; world state integrity is an application-layer concern layered on top.
